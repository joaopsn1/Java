...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Livro> livros = new ArrayList<Livro>() {
            {
                ...
                add(new Livro("Microsserviços Prontos Para a Produção: Construindo Sistemas Padronizados em uma Organização de Engenharia de Software",
                        "Susan J. Fowler", 2017));
        ...
        Collections.sort(livros, new Livro.CompararAno());
        for (Livro livro : livros) {
        ...
        Collections.sort(livros, new Livro.CompararAutor());
        for (Livro livro : livros) {
