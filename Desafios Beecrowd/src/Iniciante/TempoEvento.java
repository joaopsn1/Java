...
public class TempoEvento {
    public static void main(String[] args) throws IOException {
        ...
        String[] SdiaInicial = scanner.nextLine().split(" ");
        String[] ShoraInicial = scanner.nextLine().replaceAll(" ", "").split(":");
        String[] SdiaFinal = scanner.nextLine().split(" ");
        String[] ShoraFinal = scanner.nextLine().replaceAll(" ", "").split(":");
